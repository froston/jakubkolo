...
<div class="profile-edit col-md-6 col-md-offset-3<?php echo $this->pageclass_sfx?>">
	...
	<?php endif; ?>
		...
		<div class="form-group">
			<div class="controls">
				<button type="submit" class="btn btn-info btn-lg validate"><i class="fa fa-check"></i><span><?php echo " " . JText::_('JSUBMIT'); ?></span></button>
				<a class="btn btn-default btn-lg" href="<?php echo JRoute::_('index.php?option=com_users&view=profile'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><i class="fa fa-close"></i><?php echo " " . JText::_('JCANCEL'); ?></a>
