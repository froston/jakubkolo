...
<html>
	<head>
		<style type="text/css">
			body, td, span, p, th { background: #fff; font-size: 12px; font-family: Helvetica, Arial, sans-serif; }
								...
								<table width="100%" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td width="70%" valign="top">
											...
											<a href="<?php  echo $product_link ?>" class="product-details">Detail Produktu</a>
										</td>
									</tr>
								</table>
							</td>
