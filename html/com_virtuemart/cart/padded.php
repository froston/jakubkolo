...
echo '<hr />'; 
echo '<a class="btn btn-default btn-lg continue_link" href="' . $this->continue_link . '" ><i class="fa fa-toggle-right"></i> ' . vmText::_('COM_VIRTUEMART_CONTINUE_SHOPPING') . '</a>';
echo '<a class="btn btn-info btn-lg showcart" href="' . $this->cart_link . '"><i class="fa fa-shopping-basket"></i> ' . vmText::_('COM_VIRTUEMART_CART_SHOW') . '</a>';
