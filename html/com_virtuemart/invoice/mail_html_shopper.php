...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="html-email" style="border:solid #dad8d8 1px;margin: 10px auto;">
  ...
  <tr>
    ...
    <td width="40%" style="padding: 10px;">
    	<p>
 			<a class="default" title="<?php echo $this->vendor->vendor_store_name ?>" href="<?php echo  JRoute::_(JURI::root() . 'ucet/index.php?option=com_virtuemart&view=orders&layout=details&order_number='.$this->orderDetails['details']['BT']->order_number.'&order_pass='.$this->orderDetails['details']['BT']->order_pass); ?>">
			<?php echo vmText::_('COM_VIRTUEMART_MAIL_SHOPPER_YOUR_ORDER_LINK'); ?></a>
		</p>
	</td>
  </tr>
  <tr>
    <td colspan="3" style="padding: 10px;"><p>
	...
	<tr>
  <td colspan="3" style="padding: 10px;"><p><strong>
				<?php echo vmText::sprintf('COM_VIRTUEMART_MAIL_ORDER_STATUS',vmText::_($this->orderDetails['details']['BT']->order_status_name)) ; ?></strong></p></td>
  </tr>
