...
if($this->print){
	...
	?>
<div class="vm-wrap">
	<div class="vm-orders-information col-md-8 col-md-offset-2">
            
        <h1><?php echo vmText::_('COM_VIRTUEMART_ACC_ORDER_INFO'); ?>
	<?php
	/* Print view URL */
	$details_link = "<a title='".vmText::_('COM_VIRTUEMART_PRINT')." 'href=\"javascript:void window.open('$this->details_url', 'win2', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');\"  >";
	$details_link .= "<i class='fa fa-print'></i></a>";
	echo $details_link;
	...
	echo shopFunctionsF::getInvoiceDownloadButton($this->orderdetails['details']['BT'], "PDF") ?>
	</h1>
        
<?php if($this->order_list_link){ ?>
	<div class='show-all-orders'>
            <a class="btn btn-lg btn-default" href="<?php echo $this->order_list_link ?>" rel="nofollow"><i class="fa fa-list"></i><?php echo " " . vmText::_('COM_VIRTUEMART_ORDERS_VIEW_DEFAULT_TITLE'); ?></a>
	</div>
<?php }?>
