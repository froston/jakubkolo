...
<table class="table" width="<?php echo $widthTable ?>%" cellspacing="0" cellpadding="0" border="0">
		...
		<tr valign="top">
			...
			<td align="right"   class="priceCol" >
				...
				if (!empty($item->product_priceWithoutTax) && $item->product_discountedPriceWithoutTax != $item->product_priceWithoutTax) {
					echo '<div class="price-crossed">'.$this->currency->priceDisplay($item->product_item_price, $this->user_currency_id) .'</div>';
