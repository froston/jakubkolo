...
<table class="table table-order-order" width="100%" cellspacing="0" cellpadding="0" border="0">
    <tr>
	...
	<td align="left"><strong><?php echo $this->orderstatuses[$this->orderdetails['details']['BT']->order_status]; ?></strong></td>
    </tr>
    <tr>
...
<h3><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_BILL_TO_LBL') ?></h3>
	    <table class="table table-order-bill" border="0"><?php
	    ...
	    ?></table>
<h3><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_SHIP_TO_LBL') ?></h3>
	    <table class="table table-order-ship" border="0"><?php
