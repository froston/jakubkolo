		...
		<span><?php echo vmText::_( 'COM_VIRTUEMART_REVIEW_COUNT' ) ?>
			<input type="text" value="0" size="4" name="counter" maxlength="4" readonly="readonly"/>
				...
				if($review_editable and $this->allowReview) {
					?>
					<br/><br/>
					<button class="btn btn-default" type="submit" onclick="return( check_reviewform());"
						   name="submit_review" title="<?php echo vmText::_( 'COM_VIRTUEMART_REVIEW_SUBMIT' ) ?>"><i class="fa fa-star"></i><?php echo " " . vmText::_( 'COM_VIRTUEMART_REVIEW_SUBMIT' ) ?></button>
				<?php } else if($review_editable and $this->allowRating) { ?>
					<button class="btn btn-default" type="submit" name="submit_review"
						   title="<?php echo vmText::_( 'COM_VIRTUEMART_REVIEW_SUBMIT' ) ?>"><i class="fa fa-star"></i><?php echo " " . vmText::_( 'COM_VIRTUEMART_REVIEW_SUBMIT' ) ?></button>
				<?php
				}
...
<div class="back-to-category">
    <a href="<?php echo $this->catURL ?>" class="btn btn-lg btn-default product-details" title="<?php echo $this->categoryName ?>"><i class="fa fa-arrow-left"></i><?php echo " " . vmText::sprintf('COM_VIRTUEMART_CATEGORY_BACK_TO',$this->categoryName) ?></a>
</div>
