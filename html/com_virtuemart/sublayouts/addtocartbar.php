...
if (!VmConfig::get('use_as_catalog', 0)  ) { ?>
	...
	if (($stockhandle == 'disableit' or $stockhandle == 'disableadd') and ($product->product_in_stock - $product->product_ordered) < 1) { 
		...
		<a class="btn btn-lg btn-default ask-a-question" href="<?php echo $askquestion_url; ?>"><i class="fa fa-question-circle"></i><?php echo " " . vmText::_ ('COM_VIRTUEMART_CART_NOTIFY') ?></a><?php
	} else {
