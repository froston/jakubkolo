...
if($viewData['orderable']) {
	echo '<button type="submit" name="addtocart" class="btn btn-lg btn-default" onClick="ga(\'send\', \'event\', \'Checkout\', \'addtocart\', \'Pridat do kosiku\');"><i class="fa fa-shopping-basket"></i> '.vmText::_( 'COM_VIRTUEMART_CART_ADD_TO' ).'</button>';
} else {
