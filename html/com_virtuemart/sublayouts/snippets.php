...
if($viewData['showRating']){
  ...
  $productratingcount = $ratingModel->getVotesCountByProductId($product->virtuemart_product_id);
}
$availability = ($product->product_in_stock > 0 ? "http://schema.org/InStock" : "http://schema.org/PreOrder");
