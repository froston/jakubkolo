...
<html>
    <head>
	<style type="text/css">
            body, td, span, p, th { font-size: 11px;text-align: center;font-family: Helvetica, Arial, sans-serif;}
	    ...
	    .sectiontableentry2, .html-email th, .cart-summary th{ background: #ddd;margin: 0px;padding: 10px;}
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="html-email">
				...
				<td>
                            ...
                            <tr>
				<td>
				    <h1><?php echo vmText::sprintf('COM_VIRTUEMART_WELCOME_VENDOR', $this->vendor->vendor_store_name); ?></h1>
				</td>
			    </tr>
			</table>
			...
			<table class="html-email" cellspacing="0" cellpadding="0" border="0" width="100%">  <tr>
				<th width="100%">
				    <h2><?php echo vmText::_('COM_VIRTUEMART_VENDOR_REGISTRATION_DATA') ?></h2>
				</th>
			    </tr>
			    <tr>
