...
<div class="vendor-details-view col-md-610 col-md-offset-1">
	<h1><?php echo vmText::_('COM_VIRTUEMART_VENDOR_TOS').$this->vendor->vendor_store_name;?></h1>


	<?php // vendor Description
	if(!empty($this->vendor->vendor_terms_of_service  )) { ?>
		<div class="vendor-description tos">
