...
<?php if ($modal_framework == 'bootstrap') : ?>
	...
	<div class="jb cookie <?php echo $position; ?> <?php echo $color_background; ?> <?php echo $color_links; ?> <?php echo $moduleclass_sfx; ?>">
		...
		<p>
                    <?php echo $title; ?>
                    &nbsp;
                    <span class="btn btn-info btn-sm jb accept <?php echo $color_links; ?>"><?php echo $aliasButton; ?></span>
                </p>
...
<?php else : ?>
	...
	<div class="jb cookie <?php echo $position; ?> <?php echo $color_background; ?> <?php echo $color_links; ?> <?php echo $moduleclass_sfx; ?>">
		...
		<div class="uk-button jb accept <?php echo $color_links; ?>"><?php echo $aliasButton; ?></div>
	</div>
